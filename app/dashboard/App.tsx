        ...
        <div style={{ maxWidth: 1000, margin: '0 auto', padding: '0 1.25rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div style={{ display: 'flex', gap: 6 }}>
              <a href="https://www.instagram.com/guess_bet/" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', color: '#7a8aaa', transition: 'color .15s' }} onMouseEnter={e => (e.currentTarget.style.color='#c9a84c')} onMouseLeave={e => (e.currentTarget.style.color='#7a8aaa')}>
              ...
              <a href="https://x.com/Guess_BetApp" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', color: '#7a8aaa', transition: 'color .15s' }} onMouseEnter={e => (e.currentTarget.style.color='#c9a84c')} onMouseLeave={e => (e.currentTarget.style.color='#7a8aaa')}>
